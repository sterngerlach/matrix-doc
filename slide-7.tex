...
\begin{itemize}
  ...
  \begin{align*}
    ...
    &= 1 + \vb{t}^\top \E{\vb{x}} + \frac{1}{2!} \vb{t}^\top \E{\vb{x} \vb{x}^\top} \vb{t} + \cdots
  \end{align*}
  \item $\vb{t}$で1回微分すると,
  \begin{align*}
    \pdv{\vb{t}} \E{\exp(\vb{t}^\top \vb{x})}
    &= \E{\vb{x}}^\top + \E{\left( \vb{t}^\top \vb{x} \right) \vb{x}^\top}
      + \frac{1}{2!} \E{\left( \vb{t}^\top \vb{x} \right)^2 \vb{x}^\top} + \cdots
  \end{align*}
  \item $\vb{t} = \vb{0}$を代入すれば, $\E{\vb{x}}^\top$を得る.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \begin{align*}
    ...
    &= \E{\vb{x} \vb{x}^\top} + \E{\left( \vb{t}^\top \vb{x} \right) \vb{x} \vb{x}^\top} \\
    & \quad + \frac{1}{2!} \E{\left( \vb{t}^\top \vb{x} \right)^2 \vb{x} \vb{x}^\top} + \cdots
  \end{align*}
